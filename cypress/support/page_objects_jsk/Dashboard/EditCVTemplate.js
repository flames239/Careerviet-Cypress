...
function OnOffCoverCV() {
    cy.get(".slider").should("be.visible").click(); // Toggle On Off Cover CV
}

function Language_Font_Size() {
...
function ButtonGroup() {
    ...
    cy.get(".download-profile").find("a").should("be.visible").click(); // download CV button
}

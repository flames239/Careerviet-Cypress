...
function WorkExperience() {
    ...
    cy.get('.datepicker-months .table-condensed').find('span[class="month"]').contains("Th1").click()
    // End Date
    ...
    // Save
    ct.get('#experience-form .button-save .btn-gradient').contains('Lưu Lại').click()
}

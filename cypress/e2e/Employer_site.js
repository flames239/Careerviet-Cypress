...
describe("Employer Site", () => {
    ...
    it("Login employer then direct to postjob page and take some action", () => {
        ...
        onWorkWithhManageJob.JobOnExpired(
            "Sales Admin/ Client Operation Staff",
            "QAL123",
            "8", // option value location 4, 8, 76, 64, 781, 281, 240, 241, 75, 650, 651, 62, 78, 26, 71, 50, 1042, 511, 900, 1064, 61, 67, 59, 19, 351, 39, 320, 31, 780, 18, 321, 901, 58, 77, 60, 1069, 1070, 1071, 1072
            "- Work directly with Suppliers / Brands to follow the promotion plan, promotion budget montly/yearly \n- Work directly with Sales Department to deploy, track promotions, POSM, activation. \n- Follow the stock, inventory for expired date of products, suggest to clear products \n- Forecast sales plan with sales team, inventory management in monthly \n- Handling damaged, expired goods.",
